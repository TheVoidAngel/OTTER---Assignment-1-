...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		MeshResource::Sptr bookMesh = ResourceManager::CreateAsset<MeshResource>("AnimBook.obj");
		MeshResource::Sptr desktopMesh = ResourceManager::CreateAsset<MeshResource>("Computer.obj");
		MeshResource::Sptr chairMesh = ResourceManager::CreateAsset<MeshResource>("LoungeChair.obj");
		...
		Texture2D::Sptr    mirrortex = ResourceManager::CreateAsset<Texture2D>("textures/mirrortex.png");
		Texture2D::Sptr    chairtex = ResourceManager::CreateAsset<Texture2D>("textures/loungechairtex.png");
		Texture2D::Sptr    desktoptex = ResourceManager::CreateAsset<Texture2D>("textures/desktoptex.png");
		...
		GameObject::Sptr monkey1 = scene->CreateGameObject("Monkey 1");
		{
			...
			monkey1->SetPostion(glm::vec3(2.0f, 0.0f, 2.5f));
		...
		GameObject::Sptr book1 = scene->CreateGameObject("Book OBJ");
		{

			// Set and rotation position in the scene
			book1->SetPostion(glm::vec3(1, 3.0f, 0.0f));
			book1->SetRotation(glm::vec3(90,0,90));

			// Add a render component
			RenderComponent::Sptr renderer = book1->Add<RenderComponent>();
			renderer->SetMesh(bookMesh);
			renderer->SetMaterial(bookMaterial);

			demoBase->AddChild(book1);
		}

		GameObject::Sptr chair1 = scene->CreateGameObject("Chair OBJ");
		{

			// Set and rotation position in the scene
			chair1->SetPostion(glm::vec3(2.5f, 0.0f, 0.0f));
			chair1->SetRotation(glm::vec3(90, 0, -90));

			// Add a render component
			RenderComponent::Sptr renderer = chair1->Add<RenderComponent>();
			renderer->SetMesh(chairMesh);
			renderer->SetMaterial(chairMaterial);

			demoBase->AddChild(chair1);
		}

		GameObject::Sptr mirror1 = scene->CreateGameObject("Mirror OBJ");
		{

			// Set and rotation position in the scene
			mirror1->SetPostion(glm::vec3(5.0f, -2.0f, 4.0f));
			mirror1->SetRotation(glm::vec3(0, 0, 0));

			// Add a render component
			RenderComponent::Sptr renderer = mirror1->Add<RenderComponent>();
			renderer->SetMesh(mirrorMesh);
			renderer->SetMaterial(mirrorMaterial);

			demoBase->AddChild(mirror1);
		}

		GameObject::Sptr dtop1 = scene->CreateGameObject("Desktop OBJ");
		{

			// Set and rotation position in the scene
			dtop1->SetPostion(glm::vec3(2, -2.5f, 0.0f));
			dtop1->SetRotation(glm::vec3(90, 0, 180));

			// Add a render component
			RenderComponent::Sptr renderer = dtop1->Add<RenderComponent>();
			renderer->SetMesh(desktopMesh);
			renderer->SetMaterial(desktopMaterial);

			demoBase->AddChild(dtop1);
		}
		/*
